...
def obtener_metadatos(xml, campos, nodos, verticesfinal):
        ...
        for child_entry in root: #Cada entry
            ...
            def lastry(vertice, validar, control):
                if vertice == validar:
                    control += 'a'
